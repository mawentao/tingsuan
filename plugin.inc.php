...
$result = array (
    ...
    'site' => array (
        ...
        'sitename'    => tingsuan_env::get_sitename(),
        'admin_email' => tingsuan_env::get_admin_email(),
    ), 
    'tingsuan' => array(
        'plugin_version' => $_G['setting']['plugins']['version']["tingsuan"],
        'plugin_enabled' => $plugin_enabled,
    ),
);
tingsuan_env::result($result);
?>
