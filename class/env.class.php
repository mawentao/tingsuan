...
class tingsuan_env
{
    ...
    {/*{{{*/
        global $_G;
		$_G['siteurl'] = preg_replace("/source\/plugin\/tingsuan/i","", $_G['siteurl']);
    ...
    {/*{{{*/
        ...
        if ($charset=='gbk') {
            $sitename = tingsuan_utils::toutf8($sitename);
        }
        return $sitename;
    }/*}}}*/
    ...
    {/*{{{*/
        return self::get_siteurl().'/source/plugin/tingsuan';
    }/*}}}*/
    ...
    {/*{{{*/
        if (!self::$_log_obj) {
            ...
            self::$_log_obj = new tingsuan_log($logcfg);
        }   
